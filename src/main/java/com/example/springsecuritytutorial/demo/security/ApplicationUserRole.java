...
public enum ApplicationUserRole {
    ...
    ADMINTRAINEE(Sets.newHashSet(ApplicationUserPermission.COURSE_READ,ApplicationUserPermission.COURSE_WRITE,ApplicationUserPermission.STUDENT_READ));

    private final Set<SimpleGrantedAuthority> permissions;

    ApplicationUserRole(Set<SimpleGrantedAuthority> permissions) {
